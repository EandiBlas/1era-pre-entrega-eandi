# Tienda de Celulares
Este es un proyecto de ecommerce básico que se utiliza en la aplicación de conocimientos aprendidos en el curso de React. La aplicación permite ver una lista de celulares y realizar compras de dicho celular en línea. Los celulares y las órdenes de compra se almacenan en Firebase.
...
## Funcionalidades
- Ver una lista de Celulares disponibles
- Agregar Celulares al carrito de compras
